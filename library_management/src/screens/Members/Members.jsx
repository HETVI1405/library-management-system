...
export default function Members() {
  ...
  const filteredMembers = members.filter((member) => {
    ...
    const matchesType = filterType ? member.memberShipType === filterType : true;
    const matchesStatus = filterStatus ? member.activeStatus === filterStatus : true;
    ...
    <div className="container mt-4">
      ...
      <ol className="list-group list-group-numbered shadow-sm rounded">
        {filteredMembers.length > 0 ? (
          ...
          <li className="list-group-item text-center text-muted">No members found</li>
        )}
      </ol>
